...
const Header: FC<Props> = ({activeItem,setOpen,route,open,setRoute,setActiveItem}) => {
                                    ...
                                    user?(
                                       ...
                                       <Link href={"/profile"}>
                                            <Image 
                                                ...
                                                height={30}
                                                width={30}
                                                className={` ${activeItem===6?" border-[2px] border-[#37a39a]":"border-0"} cursor-pointer rounded-full`}
