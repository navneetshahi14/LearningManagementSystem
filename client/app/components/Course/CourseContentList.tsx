...
const CourseContentList: FC<Props> = (props) => {
  ...
  const toggleSection = (section: string) => {
    const newVisibleSecions = new Set(visibleSections);
    if (newVisibleSecions.has(section)) {
      newVisibleSecions.delete(section);
    } else {
      newVisibleSecions.add(section);
    }
    setVisibleSections(newVisibleSecions);
  };
